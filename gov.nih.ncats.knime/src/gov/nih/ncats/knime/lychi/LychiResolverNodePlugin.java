 ...
 */
public class LychiResolverNodePlugin extends Plugin {
	// The shared instance.
	private static LychiResolverNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public LychiResolverNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static LychiResolverNodePlugin getDefault() {
		return plugin;
	}
